			...
			<div id="body_content">
				...
				<div id="nav_menu" class="tinyText style_SkipStroke_1 stroke_0">
					<table>
						<tr>
							...
							<td>
								<a href="./report.php" title="Info.html"><img src="./siteimages/buttonInfo.png" alt="" style="border: none; height: 32px; width: 66px; "></a>
							</td>
						</tr>
					</table>					
				 </div>
			    ...
			    <div style="" id="info_form" class="tinyText">
					...
					<form action="javascript:submitFinePlayerForm();">
						<h4><div class="dataview2" id="dataview2";>
							<ul class="viewlist2">
					...
					<div class="dataview2" id="dataview2";>
						<ul class="viewlist2">
